...
public class AdStatisticsTest {
  ...
  public void testAddStatistic() throws AdXException {
    ...
    assertEquals(adStatistics.getStatistic(0, "enrique0", 999, null), null);
    assertEquals(adStatistics.getStatistic(0, "enrique0", 1, new Query(MarketSegment.FEMALE_YOUNG_LOW_INCOME)).getElement1(), new Integer(10));
    assertEquals(adStatistics.getStatistic(0, "enrique0", 1, new Query(MarketSegment.FEMALE_YOUNG_LOW_INCOME)).getElement2(), new Double(100.0));
    ...
    assertEquals(adStatistics.getStatistic(0, "enrique0", 1, new Query(MarketSegment.FEMALE_OLD_HIGH_INCOME)).getElement1(), new Integer(40));
    assertEquals(adStatistics.getStatistic(0, "enrique0", 1, new Query(MarketSegment.FEMALE_OLD_HIGH_INCOME)).getElement2(), new Double(400.0));
    assertEquals(adStatistics.getSummaryStatistic(0, "enrique0", 1).getElement1(), new Integer(360));
    assertEquals(adStatistics.getSummaryStatistic(0, "enrique0", 1).getElement2(), new Double(3600.0));
    assertEquals(adStatistics.getSummaryStatistic(1, "enrique1", 1).getElement1(), new Integer(1100));
    assertEquals(adStatistics.getSummaryStatistic(1, "enrique1", 1).getElement2(), new Double(4000.0));

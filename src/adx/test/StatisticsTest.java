...
public class StatisticsTest {
  ...
  public void testRegisterCampaign1() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    statistics.registerCampaign(1, new Campaign(1, MarketSegment.HIGH_INCOME, 1), "WRONG AGENT");
  }

  @Test(expected = AdXException.class)
  public void testRegisterCampaign2() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    statistics.registerCampaign(0, new Campaign(1, MarketSegment.FEMALE, 1), "agent0");
    statistics.registerCampaign(0, new Campaign(1, MarketSegment.FEMALE, 1), "agent1");
  }

  @Test
  public void testRegisterCampaign3() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    statistics.registerCampaign(1, new Campaign(1, MarketSegment.YOUNG_HIGH_INCOME, 1), "agent0");
  ...
  public void testAddStatistic0() throws AdXException {
    ...
    adStatistics.registerCampaign(0, new Campaign(1, MarketSegment.FEMALE, 1), "agent0");
    adStatistics.addStatistic(0, "agent0", 1, new Query(MarketSegment.FEMALE_YOUNG_LOW_INCOME), 10, 100.0);

    adStatistics.registerCampaign(0, new Campaign(2, MarketSegment.FEMALE, 1), "agent1");
  ...
  public void testComputeQualityScore0() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    assertEquals(statistics.computeQualityScore(1, "agent0"), new Double(1.0));
    
    Campaign c = new Campaign(1, MarketSegment.FEMALE, 100);
    statistics.registerCampaign(0, c , "agent0");
    c.setBudget(100.0);
    statistics.addStatistic(1, "agent0", 1, new Query(MarketSegment.FEMALE), 90, 0.0);
    assertEquals(statistics.computeQualityScore(1, "agent0"), new Double(0.9261666020749232));    
  }
  
  @Test
  public void testComputeQualityScore1() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    Campaign c0 = new Campaign(1, MarketSegment.FEMALE, 100);
    ...
    statistics.addStatistic(1, "agent0", 1, new Query(MarketSegment.FEMALE), 90, 0.0);
    statistics.addStatistic(1, "agent0", 1, new Query(MarketSegment.FEMALE), 90, 0.0);
    assertEquals(statistics.computeQualityScore(1, "agent0"), new Double(1.1630636924254625));    
  ...
  public void testComputeQualityScore2() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    Campaign c0 = new Campaign(1, MarketSegment.FEMALE, 100);
    Campaign c1 = new Campaign(2, MarketSegment.FEMALE, 200);
    statistics.registerCampaign(0, c0 , "agent0");
    ...
    assertEquals(statistics.computeQualityScore(1, "agent0"), new Double(0.9999766748613623));    
  ...
  public void testComputeQualityScore3() throws AdXException {
    ...
    statistics.addStatistic(1, "agent0", 2, new Query(MarketSegment.FEMALE), 200, 0.0);
    assertEquals(statistics.computeQualityScore(1, "agent0"), new Double(0.6999883374306812));    
  ...
  public void testComputeProfit0() throws AdXException {
    Statistics statistics = StatisticsTest.getStatistics();
    assertEquals(statistics.computeCumulativeProfit(1, "agent0"), new Double(0.0));
    ...
    assertEquals(statistics.computeCumulativeProfit(1, "agent0"), new Double(144.1513113566575));

    statistics.addStatistic(1, "agent0", 2, new Query(MarketSegment.FEMALE), 100, 0.0);
    assertEquals(statistics.computeCumulativeProfit(1, "agent0"), new Double(299.9883374306812));
  }
  ...
  public void testComputeProfit1() throws AdXException {
    ...
    assertEquals(statistics.computeCumulativeProfit(1, "agent0"), new Double(-14.846836508439395));
